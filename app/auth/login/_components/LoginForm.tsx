...
import { SigninSchema } from "../_config/type/login.type";
import { loginSchema } from "../_config/type/login.zod";
    ...
    <Card className="w-full max-w-md rounded-2xl shadow-md">
      <CardContent className="p-6 space-y-2">
        ...
        {showResetSuccess && (
          ...
          >
            <AlertDescription className="text-green-800 flex items-center justify-center gap-2">
              <Check />
              <span>
